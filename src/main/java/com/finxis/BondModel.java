...
public class BondModel {
    ...
    public String getNominalQuantity() {
        return nominalQuantity;
    }

    public void setNominalQuantity(String nominalQuantity) {
    ...
    public void setMaturityBucket(String maturityBucket) {
